...
import { DYNAMIC_SOURCE_KEYS, AGENT_FIELD_SOURCE_KEYS } from './tagUI.js';
...
// (see logic/tagUI.js): dynamic:<key>, bare agent field, or attribute tag path.
 ...
 *
 * @param {string} fileId - Manifest id of the config file (e.g. `'tagUI'`)
 * @param {object} doc - Raw config document
