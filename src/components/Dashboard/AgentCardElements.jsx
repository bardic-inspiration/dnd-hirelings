...
// the tag UI config plus the per-card resolution `context`
 ...
 *
 * @param {object} props
 * @param {string} props.source - Tag UI source string (e.g. `"dynamic:level"`)
 ...
 *
 * @param {object} props
 * @param {string} props.source - Tag UI source string
 * @param {object} props.context - Resolution context `{ agent, dyn, attributes }`
 * @returns {JSX.Element}
 */
