...
import { getConsumedTagPaths, isTagConsumed } from '../../logic/cardUI.js';
import { formatCount } from '../../logic/format.js';
import { useCharBudget } from '../../hooks/useCharBudget.js';
import { useCardUIConfig } from '../../hooks/useCardUIConfig.js';
...
export default function AgentCard({ agent }) {
  ...
  const cardConfig = useCardUIConfig('agentCard');
  ...
  // card config (cardUI.yml → cards.agentCard.slots), not the tag registry
  ...
  return (
    ...
    >
      {/*
        ...
        comes from public/config/cardUI.yml (see useCardUIConfig).
      */}
